...
<form class="layui-form" id="userAddForm" method="post" enctype="multipart/form-data">
    ...
    <div class="layui-form-item">
        <div class="layui-block">		
            ...
            <div class="layui-input-block">
                <input type="text" name="title" value="{{$detail['title']}}" class="layui-input input-title " lay-verify="required" placeholder="文章标题">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-block">		
            ...
            <div class="layui-input-block">
                <input type="text" name="articlepath" value="{{$detail['articlepath']}}" class="layui-input input-title " lay-verify="required" placeholder="文章路径">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="desc" placeholder="请输入内容" class="layui-textarea">{{$detail['desc']}}</textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">		
            ...
            <div class="layui-input-inline">
                <div class="user_right">
                    ...
                    <img src="{{$detail['thumbnail'] or '/index/images/demo.jpg'}}" id="imageShow">
                    <input type="hidden" value="{{$detail['thumbnail'] or '/index/images/demo.jpg'}}" name="thumbnail" id="imageShowInput">
                    <input type="hidden" value="{{$detail['thumbnail']}}" name="oldname">
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    var add_url = "{{route('index.article.update',['id'=>$detail['id']])}}"; //提交编辑路径
