    ...
    <div class="layui-form-item">
        <div class="layui-block">		
            ...
            <div class="layui-input-block">
                <input type="text" name="name" class="layui-input input-title " lay-verify="required" placeholder="文章标题">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="article_id" value="1" class="layui-input input-title " lay-verify="required" placeholder="关联文章ID">
        </div>
        <label class="layui-form-label">排序</label>
        <div class="layui-input-inline">
            <input type="text" name="sort" value="1" class="layui-input input-title " lay-verify="required" placeholder="排序">
        </div>
    </div>
    <div class="layui-form-item">
                ...
                <div class="user_right">
                    <div class="cropbox" style="display:none;">
                        <div class="imageBox" style="width: 800px;height: 420px;">
                            <div class="thumbBox" style="width: 640px;height: 320px; top:60%;left: 35%"></div>
                    ...
                    <input type="hidden" value="" name="path" id="imageShowInput">
                </div>
            </div>
        </div>
