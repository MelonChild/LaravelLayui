...
//			}
	...
	$("body").on("click",".top_tab li",function(){
		...
		var curNavId=$(this).attr("lay-id");
		$(".clildFrame div iframe").each(function(index,event){
			console.log($(event).data('id'),curNavId,$(event).data('id')==curNavId,$(event).data('id')==parseInt(curNavId));
			var childIframe=event.contentWindow;
			$(childIframe.document.getElementById('childFrame')).removeClass('layui-anim layui-anim-upbit');
			if($(event).data('id')==curNavId){
				$(childIframe.document.getElementById('childFrame')).addClass('layui-anim layui-anim-upbit')
			}
		})
		// new Tab().tabMove();
	})
